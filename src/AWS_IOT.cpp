...
int AWS_IOT::connect(char *hostAddress, char *clientID)
{
    ...
    //connectParams.will.pTopicName = "test";
    //connectParams.will.pMessage = "clientDied";
...
int AWS_IOT::connect(char *hostAddress, char *clientID, char *LWTTopic, char *LWTMessage)
{
    const size_t stack_size = 36*1024;
    ...
    //ADD IN Last Will Testament (LWT) settings
    connectParams.isWillMsgPresent = true;
    connectParams.will.isRetained = false;
    connectParams.will.pTopicName = LWTTopic;
    connectParams.will.topicNameLen = (uint16_t) strlen(LWTTopic);
    connectParams.will.pMessage = LWTMessage;
    connectParams.will.msgLen = (uint16_t) strlen(LWTMessage);

    //connectParams.isWillMsgPresent = false;

    ESP_LOGI(TAG, "Connecting to AWS with LWT...");
