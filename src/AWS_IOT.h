...
typedef void (*pSubCallBackHandler_t)(char *topicName, int topicNameLen, int payloadLen, char *payLoad);
...
class AWS_IOT{
    ...
    int connect(char *hostAddress, char *clientID, char *LWTTopic, char *LWTMessage);
